...
def main():
	...
	char_class = input(f"What do you want your class to be {player_character.char_name}? >>> ")
	if 'r' in char_class:
	...
	print(f"{player_character.char_name}, {player_character.char_age}, {player_character.char_strength}, {player_character.char_hitpoints}")
